...
const MyCustomToolbar = (toolbarProps: ToolbarProps) => {
  const goToBack = () => {
...
const App: React.FC = () => {
  ...
  return (
    <div className="app-container">
      <h1 style={{ textAlign: 'center', margin: '20px 0' }}>My Outlook-Style Calendar</h1>
      <div className="calendar-container">
        <Calendar
          ...
          startAccessor="start"
          endAccessor="end"
          style={{ height: '80vh', margin: '0 auto', width: '90%' }}
          components={{
